...
export const lessonConfigs: Record<string, LessonConfig> = {
  ...
  "vocab-colours": {
    ...
    levelTitle: "Everyday Vocab",
    duration: "6 min",
    tags: ["colours", "Descriptive", "Vocab"],
    vocab: [
      { key: "sign_colour",  label: "colour",  mediaType: "video", mediaSrc: "/asl_videos/colours/colour.mp4",  description: "Hold a 5-hand in front of your face and wiggle the fingers, like mixing paint." },
      { key: "sign_red",    label: "RED",    mediaType: "video", mediaSrc: "/asl_videos/colours/red.mp4",    description: "Draw your index finger downward across your lips — the colour of your lips." },
      { key: "sign_blue",   label: "BLUE",   mediaType: "video", mediaSrc: "/asl_videos/colours/blue.mp4",   description: "B-hand (four fingers up) shakes side to side at the side of your body." },
      { key: "sign_green",  label: "GREEN",  mediaType: "video", mediaSrc: "/asl_videos/colours/green.mp4",  description: "G-hand (index and thumb out) shakes side to side." },
      { key: "sign_yellow", label: "YELLOW", mediaType: "video", mediaSrc: "/asl_videos/colours/yellow.mp4", description: "Y-hand (thumb and pinky out) shakes side to side." },
      { key: "sign_orange", label: "ORANGE", mediaType: "video", mediaSrc: "/asl_videos/colours/orange.mp4", description: "C-hand in front of the face squeezes open and shut, like squeezing an orange." },
      { key: "sign_black",  label: "BLACK",  mediaType: "video", mediaSrc: "/asl_videos/colours/black.mp4",  description: "Index finger slides across your forehead from one side to the other." },
      { key: "sign_white",  label: "WHITE",  mediaType: "video", mediaSrc: "/asl_videos/colours/white.mp4",  description: "5-hand on chest pulls away, fingers closing into a flat O." },
    ],
  },
